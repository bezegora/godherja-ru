...
public class CharacterGenerator2 {
	/*
	JFrame f;  
	CharacterGenerator2(){  
...
public void actionPerformed(ActionEvent e){  
	...
	*/
	...
	JLabel dynastyLabel = new JLabel("Dynasty List File Path");
	...
	generateButton.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent e){  
			...
			if (female.equals("random")) rand_gender = false;
			//pull minimum age
		...
		for (int i = start; i < start+amount; i++)
		{
			...
			if (female.equals("yes")) name = femaleNames.get(rand.nextInt(dynasties.size()));
